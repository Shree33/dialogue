...
module.exports = !__webpack_require__(10) && !__webpack_require__(4)(function () {
  return Object.defineProperty(__webpack_require__(94)('div'), 'a', { get: function get() {
      return 7;
    } }).a != 7;
});
...
var _baseGetTag = __webpack_require__(414);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(419);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(421);
...
var _root = __webpack_require__(415);
...
var _combineReducers = __webpack_require__(424);

var _combineReducers2 = _interopRequireDefault(_combineReducers);

var _bindActionCreators = __webpack_require__(425);

var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);

var _applyMiddleware = __webpack_require__(426);
...
var _wrapStore = __webpack_require__(463);

var _wrapStore2 = _interopRequireDefault(_wrapStore);

var _alias = __webpack_require__(465);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(17)(proto, TO_PRIMITIVE, __webpack_require__(296));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(61), __webpack_require__(86)(module)))
...
var _Symbol2 = __webpack_require__(173);

var _Symbol3 = _interopRequireDefault(_Symbol2);

var _getRawTag = __webpack_require__(417);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(418);
...
var _freeGlobal = __webpack_require__(416);
...
var _overArg = __webpack_require__(420);
...
var _assignIn = __webpack_require__(428);
...
var assignValue = __webpack_require__(430),
...
var arrayLikeKeys = __webpack_require__(449),
    baseKeysIn = __webpack_require__(460),
    isArrayLike = __webpack_require__(183);
...
var baseTimes = __webpack_require__(450),
    isArguments = __webpack_require__(451),
    isArray = __webpack_require__(453),
    isBuffer = __webpack_require__(454),
    isIndex = __webpack_require__(185),
    isTypedArray = __webpack_require__(456);
...
var baseIsTypedArray = __webpack_require__(457),
    baseUnary = __webpack_require__(458),
    nodeUtil = __webpack_require__(459);
...
var isObject = __webpack_require__(67),
    isPrototype = __webpack_require__(461),
...
var _shallowDiff = __webpack_require__(464);
...
_store2.default.subscribe(function () {
  _store2.default.getState().bookmark.tabs.map(function (infoTab) {
    chrome.alarms.create(infoTab.tab[0].url, { when: infoTab.expiry + _store2.default.getState().settings.expireDate });
  });
});

chrome.alarms.onAlarm.addListener(function (data) {
  var elementExpired = _store2.default.getState().bookmark.tabs.filter(function (el) {
    return el.tab[0].url === data.name;
  });
  _store2.default.dispatch({ type: 'EXPIRY', url: elementExpired[0].tab[0].url });
});
...
var _reactChromeRedux = __webpack_require__(210);

var _reduxLogger = __webpack_require__(628);
...
var _throttle = __webpack_require__(634);

var _throttle2 = _interopRequireDefault(_throttle);

var _localStorage = __webpack_require__(639);
...
var _bookmarks = __webpack_require__(631);

var _bookmarks2 = _interopRequireDefault(_bookmarks);

var _settings = __webpack_require__(632);

var _settings2 = _interopRequireDefault(_settings);

var _animations = __webpack_require__(633);
...
exports.default = (0, _redux.combineReducers)({
  bookmark: _bookmarks2.default,
  settings: _settings2.default,
  animation: _animations2.default
});
  ...
  switch (action.type) {
    case "ADD":
      return _extends({}, state, {
        tabs: [{ tab: action.urlList, expiry: action.expiry }].concat(_toConsumableArray(state.tabs))
      });
    ...
    case "DELETE-ONE":
      return _extends({}, state, {
        tabs: [].concat(_toConsumableArray(state.tabs.filter(function (element) {
          return element.tab[0].url !== action.url;
        }))),
        addFromButton: false
      });
    case "EXPIRY":
      return _extends({}, state, {
        ...
        chronology: [].concat(_toConsumableArray(state.tabs.filter(function (element) {
          return element.tab[0].url === action.url;
        })), _toConsumableArray(state.chronology))
      });
    case "SEARCH":
      return _extends({}, state, {
        searchResult: [].concat(_toConsumableArray(state.tabs.filter(function (element) {
          return element.tab[0].title.toLowerCase().indexOf(action.textSearched.toLowerCase()) !== -1;
        })), _toConsumableArray(state.chronology.filter(function (element) {
          return element.tab[0].title.toLowerCase().indexOf(action.textSearched.toLowerCase()) !== -1;
        }))),
...
var debounce = __webpack_require__(635),
    isObject = __webpack_require__(67);
...
var isObject = __webpack_require__(67),
    ...
    toNumber = __webpack_require__(637);
...
var isObject = __webpack_require__(67),
    isSymbol = __webpack_require__(638);
